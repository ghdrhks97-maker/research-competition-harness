    ...
    [
        ...
        (
            "brainstorm",
            {
                ...
                "purpose": "대회 심사 기준에 맞는 제목, 연구 질문, 수업 모형, 실천과제 구조를 만든다.",
                "inputs": ["input/ideas/", "input/rules/", "input/evidence/"],
                "process": [
                    "알파벳 약어와 한글 스토리를 함께 만든다.",
                    "주제축과 수업단계축을 분리해 이중 프레임 가능성을 검토한다.",
        ...
        (
            ...
            {
                "title": "표 중심 편집 설계",
                "purpose": "보고서를 심사자가 빠르게 읽을 수 있게 표, 카드, 문단 밀도를 설계한다.",
                ...
                "process": [
                    ...
                    "25쪽 제한을 전제로 표 폭, 행 수, 문장 길이를 보수적으로 잡는다.",
                ],
                "outputs": [
                    "table-map",
                    "page-flow plan",
